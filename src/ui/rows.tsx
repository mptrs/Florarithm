...
export function RowLink({
  ...
  return (
    <a
      href={href}
      className={cn(
        'flex min-h-touch items-center gap-4 border-b border-line px-3 py-3',
...
export function Row({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div className={cn('flex min-h-touch items-center gap-4 border-b border-line py-3', className)}>
      {children}
    </div>
  )
}
...
export function DrawerLabel({
  ...
  return (
    <div className={cn('mt-6 mb-2 flex items-center gap-2', className)}>
